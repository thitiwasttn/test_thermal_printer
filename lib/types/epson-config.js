module.exports = {
    ...
    BEEP: Buffer.from([0x1b, 0x42, 0x03, 0x05]),               // Sounds built-in buzzer (if equipped)
    ...
    // Cash Drawer
    CD_KICK_2: Buffer.from([0x1b, 0x70, 0x00, 0xFF, 0x00]),      // Sends a pulse to pin 2 []
    CD_KICK_5: Buffer.from([0x1b, 0x70, 0x01, 0xFF, 0x00]),      // Sends a pulse to pin 5 []
    ...
    CODE_PAGE_PC874: Buffer.from([0x1b, 0x74, 0xFF]),
